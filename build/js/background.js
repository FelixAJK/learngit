(function() {
  ...
  globalThis.isBrowserRestart = globalThis.startupCheck === void 0;

  globalThis.hasStartupCheck = !globalThis.isBrowserRestart;

  startupCheck = globalThis.startupCheck != null ? globalThis.startupCheck : globalThis.startupCheck = function() {
    return true;
  };
  ...
  zeroBackground = function(zeroStorage, opts) {
    ...
    actionForUrl = function(url) {
      return options.ready.then(function() {
        ...
        var attached, badgeText, condition, condition2Str, current, currentName, details, direct, icon, name, profile, profileColor, realCurrentName, result, resultColor, results, shortTitle, _i, _len, _ref1, _ref2;
